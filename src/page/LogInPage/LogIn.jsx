  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (token && user) {
        ...
        setError("Respon login tidak valid dari server.");
      }
    } catch (err) {
      setError(
        err.response?.data?.message ||
        "Gagal masuk. Silakan periksa email, kata sandi, atau koneksi server Anda."
      );
    } finally {
      setLoading(false);
    }
          ...
          <div className={styles.content}>
            ...
            <form onSubmit={handleLoginSubmit} className={styles.form}>
              ...
              <div className={styles.buttonWrapper}>
                <MainButton onClick={handleLoginSubmit} disabled={loading}>
