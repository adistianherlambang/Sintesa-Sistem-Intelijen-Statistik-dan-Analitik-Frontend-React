...
import styles from "./IHK.module.css"
...
export default function IHK({onLoad}) {
  ...
  return (
    <div className={styles.container}>
      <p className={styles.title}>Index Harga Konsumen</p>
      <h1 className={styles.value}>{now}%</h1>
      {isDecrease ?
        <div className={styles.comparison}>
          ...
          <p><span className={styles.trendUp}>{compare}</span> vs last month</p>
        </div>
        :
        <div className={styles.comparison}>
          ...
          <p><span className={styles.trendDown}>{compare}</span> vs last month</p>
        </div>
      }
    </div>
  )
